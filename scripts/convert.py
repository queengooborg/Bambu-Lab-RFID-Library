...
def sync_directory(path, create_files=True):
...
if __name__ == "__main__":
    ...
    parser.add_argument('directory', help='Directory containing tag data')
    parser.add_argument('-n', '--no-create', action='store_false', dest='create_files',
                        help='Do not create missing files')
    args = parser.parse_args()

    sync_directory(Path(args.directory), args.create_files)
